...
public class BinSearch
{
  ...
  **/
  ...
  public static void main ( String[] args )
  {
    ...
    System.out.println( binSearch(iArr3,4) ); //2
    System.out.println( binSearch(iArr3,8) ); //4
    System.out.println( binSearch(iArr3,5) ); //-1
